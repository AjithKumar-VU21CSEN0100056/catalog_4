...
public class Main {
    ...
    private static final String GRAPHICAL_PASSWORD = "xuv234"; // Example graphical password

    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);

        userDatabase.put("Ajith", "ajith@123");
        // userDatabase.put("kumar", "kumar@123");// Username and password
